                    ...
                    <div class="product-banner-carousel slick-row-10">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/dien-thoai.png" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">IPHONE</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                ...
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">SAMSUNG</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                ...
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">AIRPODS</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                ...
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">PHỤ KIỆN</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/laptop.png" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">LAPTOP</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- section title start -->
                    <div class="section-title text-center">
                        <h2 class="title">Sản phẩm nôi bật</h2>
